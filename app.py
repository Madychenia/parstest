...
for i, t_tag in enumerate(tabs):
    ...
    with t_tag:
        ...
        if items:
            ...
            sel_cat = st.selectbox("", df_tab['Категория'].unique(), key=f"s_{tag_key}", label_visibility="collapsed")
